# Create the Node.js/Express backend implementation
...
# Save the Express server file
with open('server.js', 'w') as f:
    f.write(express_server_code)

print("✅ Node.js/Express Backend Created Successfully!")
print("📁 File: server.js")
print("🛠️ Features:")
print("- RESTful API endpoints for form submission")
print("- PostgreSQL integration")
print("- JWT authentication")
print("- Input validation with express-validator")
print("- Rate limiting for OTP requests")
print("- Security middleware (helmet, cors)")
print("- Error handling")
print("- OTP generation and verification")
print("- PAN validation logic")